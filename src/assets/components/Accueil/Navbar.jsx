          ...
          {navLinks.map((link, i) => (
            ...
            >
              ...
              >
                ...
                />
                <motion.div className="absolute inset-0 transition-transform duration-300 scale-0 rounded-lg bg-gradient-to-r from-orange-500/10 to-red-500/10 group-hover:scale-100 -z-10" />
              </Link>
            </motion.div>
          ))}
              ...
              {isDropdownOpen && (
                ...
                >
                  {dropdownLinks.map((item, i) => (
                    <motion.div key={i} variants={dropdownItemVariants}>
                      <Link
                        to={item.path}
